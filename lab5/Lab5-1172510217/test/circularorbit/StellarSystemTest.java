...
class StellarSystemTest {
  ...
  @Test void testCheckRep() {
    ...
    StellarSystemObject planet =
        new StellarSystemObject("A", "B", "C", 1, 2, "CW", 0);
    ...
    StellarSystemObject planet3 =
        new StellarSystemObject("D", "B", "C", 4, 2, "CW", 0);
  ...
  @Test void testCalculatePosition() {
    ...
    // 旋转方向为CCW
    StellarSystemObject planet2 =
        new StellarSystemObject("A", "B", "C", 1, 2, "CCW", 0);
  ...
  @Test void testGetPhysicalDistance() {
    ...
    StellarSystemObject planet2 =
        new StellarSystemObject("A1", "B", "C", 1, 2, "CW", 0);
    track2.add(planet2);
